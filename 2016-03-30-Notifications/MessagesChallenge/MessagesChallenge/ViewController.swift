...
class ViewController: UIViewController {
   static var messages = MessageModel.savedMessages != nil ? MessageModel.savedMessages! : [MessageModel]()
    ...
    func addNewMessage(newMessage : MessageModel) {
        ...
        ViewController.messages.insert(newMessage, atIndex: 0)
...
extension ViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.message = ViewController.messages[indexPath.row]
    ...
    func sendMessageToWatch(message: MessageModel) {
        ...
        dispatch_async(dispatch_get_main_queue(), {
            ...
            if message.messageText != nil {
                ...
                let myImageName = "imagesTransferChallenge\(ViewController.messages.count).png"
